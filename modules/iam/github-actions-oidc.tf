...
data "aws_iam_policy_document" "github_actions_assume_role" {
  statement {
    ...
    condition {
      ...
      values = [
        "repo:${var.github_org}@57027783/frontend@1348883692:ref:refs/heads/main",
        "repo:${var.github_org}@57027783/frontend@1348883692:ref:refs/heads/develop",

        "repo:${var.github_org}@57027783/backend@1348884013:ref:refs/heads/main",
        "repo:${var.github_org}@57027783/backend@1348884013:ref:refs/heads/develop",
      ]
    }
  }
}
